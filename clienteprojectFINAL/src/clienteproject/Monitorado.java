...
public class Monitorado {
	...
	/** Porta que o ServerSocket ficara aguardando solicitacoes */
	...
	/** Método Cmd Dispositivo envia informacoes de portas abertas na interface de rede para o Monitor
	 * @param sock Socket que vai se conectar
	 */
	...
	/** Metodo Desligar Dispositivo recebe sinal de desligamento do Monitor
	 * @param sock Socket que vai se conectar
	 */
	private static void DesligarDisp(Socket sock) {
		JOptionPane.showMessageDialog(null,"O Computador Ser� Desligado!!!","",JOptionPane.ERROR_MESSAGE);
		String command = "";
	...
	/** Metodo Alertar Dispositivo recebe um Alerta do Monitor
	 * @param sock Socket que vai se conectar
	 */
	
	private static void alertar(Socket sock) {
		try {
			JOptionPane.showMessageDialog(null,"Voc� esta Sendo Monitorado - CUIDADO!!!","",JOptionPane.ERROR_MESSAGE);
			System.out.println("concluido...");
		} catch (Exception e) { System.out.println(e.getMessage()); }
	}		

	/** Verifica se o Sistema Operacional do Monitorado e Windows
	 * @return Verdadeiro caso seja Windows, Falso caso contrario
	 */
	 ...
	 * @return Verdadeiro caso seja Mac, Falso caso contrario
	 */
	 ...
	 * @return Verdadeiro caso seja Linux, Falso caso contrario
	 */
