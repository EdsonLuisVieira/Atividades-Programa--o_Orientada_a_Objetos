...
public class Main {
	...
	private static void listarIntrusos(ArrayList<String> hosts){
		...
		//}else {System.out.println("Não Existe Dispositivos  [Recomenda-se recapturar informacoes]");}
	}
	...
	private static void capturarPortasAll(ArrayList<String> hosts){
		...
		}else {System.out.println("Não Existe Dispositivos clientes [Recomenda-se recapturar informacoes]");}
